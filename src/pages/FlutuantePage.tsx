        ...
        <section className="bg-white py-16 sm:py-20">
          <div className="container mx-auto px-5 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-5 leading-7 text-muted-foreground">Uma solução que junta o aspeto natural do laminado à estabilidade de um núcleo HDF reforçado com carbono. A coleção inclui sete acabamentos, classe AC5, base acústica integrada e resistência à água e aos salpicos 100 h+.</p>
            </div>
            <div className="mx-auto mt-9 grid max-w-5xl gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-[#e2ddd5] bg-[#f8f5ef] p-5"><p className="text-xs font-bold uppercase tracking-[0.14em] text-[#239da7]">Instalação cuidada</p><p className="mt-2 font-display text-lg font-bold">Fornecimento e aplicação</p><p className="mt-2 text-sm leading-6 text-slate-600">Servimos Coimbra, Aveiro, Leiria e arredores. Outras zonas ficam sujeitas a contacto e disponibilidade.</p></div>
            </div>
            <div className="mt-8 text-center">
              <a href="/loja?categoria=flutuante#catalogo-loja" className="inline-flex rounded-full bg-primary px-6 py-3 font-bold text-white transition hover:bg-[#d94d0d]">Ver cores ZCUDO NextCore</a>
            </div>
          </div>
        </section>
