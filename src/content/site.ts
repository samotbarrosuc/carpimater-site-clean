...
export const SITE_VARIANT_CONTENT: Record<SiteVariant, SiteVariantContent> = {
  vinilico: {
    ...
    heroTitle: 'Pavimento vinílico SPC em Coimbra',
    ...
    heroServiceLine: 'Fornecimento e aplicação',
  ...
  flutuante: {
    subtitle: 'Flutuante Híbrido ZCUDO',
    ...
    supplierWarrantyLabel: '25 anos',
    heroTitle: 'Pavimento flutuante em Coimbra',
