        ...
        <div className="mx-auto mb-9 max-w-2xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-muted-foreground sm:text-base">
            {isKitchen
              ...
              : 'Centenas de obras realizadas, com atuação regular na Região Centro.'}
          </p>
          <div className="mt-5 inline-flex items-center gap-2 rounded-xl border border-border bg-white px-3.5 py-2 text-sm shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="clean-card rounded-2xl p-6 sm:p-7"
            >
              {/* Stars */}
